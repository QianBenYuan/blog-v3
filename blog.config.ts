...
const basicConfig = {
	...
	author: {
		...
		email: '',
		homepage: 'https://blog.qianbenyuan.dpdns.org/',
	},
	copyright: {
	...
	language: 'zh-CN',
	timeEstablished: '2026-07-20',
	timeZone: 'Asia/Shanghai',
	url: 'https://blog.qianbenyuan.dpdns.org/',
	defaultCategory: '未分类',
}
...
const blogConfig = {
	...
	article: {
		categories: {
			...
			/** 工具：CTF / 开发 / 日常实用工具、软件与配置 */
			工具: { icon: 'tabler:tool', color: '#a855f7' },
			/** 学习：学习笔记/基础教程 */
